...
$db = new ConnectionManager();
	...
	$sQuery = "SELECT *"
		." FROM daily_report WHERE send_report='Y'";	
...
EOD;
			...
			$subject     =  utf8_decode('SenseGiz Daily Report');  
			$messageEmail = utf8_decode('Please find attached the daily report from SenseGiz.');
...
function sendMails($userID, $emailsArray, $subject, $message){
	...
	$filename= 'sensegiz-mqtt/' .$userID . "_DailyReport.pdf"; 
