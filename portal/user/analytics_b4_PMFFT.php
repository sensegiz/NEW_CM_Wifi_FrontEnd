            ...
            //                               date      =  added_on +'Z'; 
					...
					if(status == 'Online'){
						...
						status_html = '&nbsp&nbsp&nbsp<img src="../img/offline.png"/>';
                                        ...
                                        gw_li_html += '<li><a href="javascript:;" class="asGw" data-gateway="'+gateway_id+'"  data-is_active="'+is_active+'" data-is_blacklisted="'+is_blacklisted+'" data-added_on="'+added_on+'" data-updated_on="'+date+'">'+gateway_name+''+status_html+'</a></li>';
                                    });                        
                                }
                                else{
            ...
            success: function(data, textStatus, xhr){
                ...
                if(data.records.length > 0){
                    ...
                    $.each(records, function(index, value){
                        ...
                        gw_di_list += '<div class="col-sm-1 asDvList" href="javascript:;"><p class="asGwDv" data-frequency="'+frequency+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-nick_name="'+nick_name+'">'+nick_name+'</p></div>';
...
$(document).on('click', '.asGwDv', function(e)
{
	...
	if(uid!= '' && apikey!= '')
	{
		...
		dv_ss_list += '<div href="javascript:;" class="col-md-3 accTypes" data-frequency="'+frequency+'" data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="12">Accelerometer Types <span class="glyphicon glyphicon-chevron-right"></span></div>';		
		dv_ss_list += '<div href="javascript:;" class="col-md-3 predTypes" data-frequency="'+frequency+'" data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="51">Spectrum Types <span class="glyphicon glyphicon-chevron-right"></span></div>';
...
$(document).on('click', '.accTypes,bCrum', function(e)
{
	...
	if(uid!= '' && apikey!= '')
	{
			...
			acc_types += '<div href="javascript:;" class="col-md-3 accStream" data-frequency="'+frequency+'" data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="111"><p>FFT (Fast Fourier Transform)</p></div>';		
			...
			acc_types += '<div href="javascript:;" class="col-md-3 asGwDv" data-frequency="'+frequency+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-nick_name="'+nick_name+'"><span class="glyphicon glyphicon-chevron-left"></span>&nbsp;&nbsp;Sensors</div>';
...
function drawStreamFilteredChart(gateway_id, device_id, device_type1, startTime, endTime)
{
    ...
    console.log('device_type1 device_type1==' + startTime + 'endTime== '+endTime);
...
function changeStreamGraph() 
{
	...
	var radiostreamval = $("input[name='Accstream']:checked").val();
    console.log('changeStreamGraph radiostreamval', radiostreamval);

    var radioPredstreamval = $("input[name='Predstream']:checked").val();
	console.log('changeStreamGraph radioPredstreamval', radioPredstreamval);
    ...
    console.log('changeStreamGraph newurl', newurl, device_type1, radiostreamval);
	if(uid!= '' && apikey!= '') {
		clearInterval(autohandle);
...
function autoChangeStreamGraph(gateway_id, device_id, device_type1, nick_name, startTime, endTime, radiostreamval, newurl) 
{
	...
	var date_format  =  $('#sesval').data('date_format');
	var rms_values  =  $('#sesval').data('rms_values');
    console.log('autoChangeStreamGraph newurl==',newurl);
...
var apiUrlFilteredFFTData = "get-filtered-fft-base-data";
    ...
    function getFFTvalues(gateway_id, device_id, device_type1, nick_name, sensor_axis, frequency)
    {
        var uid     =  $('#sesval').data('uid');
        var apikey  =  $('#sesval').data('key');
        ...
        $.ajax({
                ...
                success: function(data, textStatus, xhr) 
                {
                    if(data.records.length>1)
                    {
                        ...
                        // document.getElementById('FFTinputValues').innerHTML = signal;
                    ...
                    showBreadCrumb(gateway_id, device_id, nick_name, 111, uid, apikey);

					if(fillAxis == ''){
                        console.log('getFFTvalues',sensor_axis);
		                showFFTFilter(gateway_id, device_id, device_type1, nick_name, sensor_axis, frequency);
					}
	...
	/* Start FFT Filter */
	function showFFTFilter(gateway_id, device_id, device_type1, nick_name, sensor_axis, frequency)
	{
	    var str, val=0;
        ...
        var filter_html = '&nbsp;&nbsp;&nbsp;&nbsp; Axis:&nbsp;&nbsp;<select class="filterAxisSelect" id="filterAxisSelect"><option value="0" >Select Axis</option><option value="12" >X-Axis</option><option value="14" >Y-Axis</option><option value="15">Z-Axis</option></select> ' +
        ...
        $.ajax({
                ...
                success: function(data, textStatus, xhr) 
                {
                    if(data.records.length>1)
                    {
                        ...
                        if(sensor_axisSelected == '12')
                        {
                        	fftSensor_html = '<h4 style="margin-left: 50px;">X-Axis</h4>';
                        }else if(sensor_axisSelected == '14')
                        {
							fftSensor_html = '<h4 style="margin-left: 50px;">Y-Axis</h4>';
                        }else if(sensor_axisSelected == '15')
                        {
                        	fftSensor_html = '<h4 style="margin-left: 50px;">Z-Axis</h4>';
                        }
                        $('.fftSensor_html').html(fftSensor_html);
...
$(document).on('click', '.predTypes,bCrum', function(e)
{
	...
	if(uid!= '' && apikey!= '')
	{
		...
		acc_types = '<div href="javascript:;" class="col-md-3 predStream" data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="51"><p>Spectrum Stream</p></div>';	
		//acc_types += '<div href="javascript:;" class="col-md-3 predStream" data-frequency="'+frequency+'" data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="111"><p>FFT (Fast Fourier Transform)</p></div>';		
		acc_types += '<div href="javascript:;" class="col-md-3 predStream " data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="57"><p> Spectrum Acceleration </p></div>';
		acc_types += '<div href="javascript:;" class="col-md-3 predStream" data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="60"><p>Spectrum Velocity</p></div>';
		acc_types += '<div href="javascript:;" class="col-md-3 predStream" data-nick_name="'+nick_name+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-device_type1="63"><p>Spectrum Displacement</p></div>';
		acc_types += '<div href="javascript:;" class="col-md-3 asGwDv" data-frequency="'+frequency+'" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-nick_name="'+nick_name+'"><span class="glyphicon glyphicon-chevron-left"></span>&nbsp;&nbsp;Sensors</div>';
...
{	
	...
	if(uid != '' && apikey != '') {
		...
		if(device_type1 == '111') {
			...
			getanalyticsPredStream(gateway_id, device_id, nick_name, device_type1);
			autohandle = setInterval(function(){ getanalyticsPredStream(gateway_id, device_id, nick_name, device_type1); }, 60000);
		}
		/*getanalyticsAcceStream(gateway_id, device_id, nick_name, device_type1);
		autohandle = setInterval(function(){ getanalyticsAcceStream(gateway_id, device_id, nick_name, device_type1); }, 60000);*/
...
function getanalyticsPredStream(gateway_id, device_id, nick_name, device_type1)
{
	var uid = $('#sesval').data('uid');
    var apikey = $('#sesval').data('key');
	var date_format  =  $('#sesval').data('date_format');
