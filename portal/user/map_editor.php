...
<link rel="stylesheet" href="../public/leaflet/leaflet.css"></script>
...
<div class="container-fluid text-center">
	<div class="row content" style="margin-top:85px">
    		...
    		<div class="col-md-6 col-xs-12 col-lg-4 col-sm-6 productDetails">
    			<div class="row">
				<div style="margin-top:6px"><h1>Map Studio Editor</h1></div><hr>
		
				<div id="addInfo" style="height:100%; width:100%;">
				<div class="col-md-12"><div class="well">Select a Gateway</div></div>
				</div>
			</div>
			<div class="row deviceInfo">
				...
				<input type="text" name="gateway" id="searchGateway" onkeyup="searchGateway()" placeholder="Search Gateway...">
