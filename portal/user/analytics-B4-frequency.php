...
$(document).on('click', '.accTypes,bCrum', function(e)
{
	...
	if(uid!= '' && apikey!= '')
	{
			...
			acc_types += '<div href="javascript:;" class="col-md-3 asGwDv" data-gateway_id="'+gateway_id+'" data-device_id="'+device_id+'" data-nick_name="'+nick_name+'"><span class="glyphicon glyphicon-chevron-left"></span>&nbsp;&nbsp;Sensors</div>';
...
var apiUrlFilteredFFTData = "get-filtered-fft-base-data";
	...
	function showFFTFilter(gateway_id, device_id, device_type1, nick_name, sensor_axis, frequency)
	{
        ...
        var filter_html = '&nbsp;&nbsp;&nbsp;&nbsp; Axis:&nbsp;&nbsp;<select class="filterAxisSelect" id="filterAxisSelect"><option value="0" >Select Axis</option><option value="12" >X-Axis</option><option value="14" >Y-Axis</option><option value="15">Z-Axis</option></select> ' +
			'&nbsp;&nbsp;&nbsp;&nbsp; <span class="dateTimeInputs"> Date :&nbsp;&nbsp; <input type="text" id="startTime" display="none" style="width:130px;margin-top:12px"> &nbsp;&nbsp;&nbsp;&nbsp; <input type="text" id="endTime" display="none" style="width:80px;margin-top:12px"/>' +
			'&nbsp;&nbsp; <button id="btnfftfilter"> Submit </button> </span>' +
	    ...
	    $("select").change(function() {
	        ...
	        // valAxis = $("select option:selected").val();
	...
	$(document).on('click', '#btnfftfilter', function(e)
	{
	    ...
	    if(uid!= '' && apikey!= '') {
            ...
            autohandle = setInterval(function(){ getFilteredFFTvalues(gateway_id, device_id, device_type1, sensor_axisSelected, startTime, endTime, frequency) }, 60000);
		}
	});
    ...
    function arrayToCSV () {
        ...
        if(startT != '' && endT != '')
        {
            ...
            downloadFilteredFFTvalues(gateway_id, device_id, device_type1, nick_name, sensor_axis, startTime, endTime, frequency, downloadType);
        }else{
            downloadFFTvalues(gateway_id, device_id, device_type1, nick_name, sensor_axis, frequency);
        }
        ...
        $.ajax({
                ...
                success: function(data, textStatus, xhr) 
                {
                    if(data.records.length>1)
                    {
                        ...
                        _FFTvaluesdownload(signal, bufferSize, samplingRate, gateway_id, device_id, device_type1, nick_name, sensor_axisSelected, frequency);
