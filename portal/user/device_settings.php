...
<div class="modal fade" id="modalEditNickName" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
	...
	<div class="container-fluid">
          ...
          <div class="form-group">
                    <div>
                  <label>Gateway ID: </label><input class="form-control" type="text" id="gateway" name="gateway"  value=""  disabled style="margin-left:3px"/ >
                </div></div>
		<div class="form-group">
		<div>
                  <label>Current Coin Name: </label><input class="form-control" type="text" id="nickname" name="nickname"  value=""  disabled style="margin-left:3px"/ >
                </div>
		<div>
  		...
  		<span class='errorloc'></span>
                 <label>New Coin Name:</label> <br><input class="form-control" name="newcoinname" id="newcoinname" type="text" value="" >
                </div>
	...
	<div class="form-group">
		<div>
		<button type="button" class="btn btn-primary updatenickname" id="updatenickname" style="margin-left:3px">Update Nick Name</button>
		</div>
	   </div>
	</form>
	</div>
                    ...
                    <div class="col-md-3">
                        <div class="CoinListLoc">
                            ...
                            <form class="form-horizontal" id="coinLocForm">
                                ...
                                <div class="form-group">
                                    <div>
                                    	<input class="form-control" type="hidden" id="gateway_coin_loc" name="gateway_coin_loc"  value=""  disabled style="margin-left:3px" / >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div>
                                        <label>Current Coin Location: </label><input class="form-control" type="text" id="cur_coin_location" name="cur_coin_location"  value=""  disabled style="margin-left:3px"/ >
                                    </div>
                                    <div>
                                      <input class="form-control" type="hidden" id="deviceId_coin_loc" name="deviceId_coin_loc"  value="" / >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div>
                                        <span class='errorloc'></span>
                                        <label>New Coin Location:</label> <br><input class="form-control" name="txtCoinNewloc" id="txtCoinNewloc" type="textStatust" value="" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div>
                                        <button type="button" class="btn btn-primary btnUpdateCoinLoc" id="btnUpdateCoinLoc" style="margin-left:3px">Update Location</button>
                                    </div>
                                </div>
                            </form>
                        </div>
