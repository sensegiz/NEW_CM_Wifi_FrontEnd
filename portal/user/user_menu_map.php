  ...
  <!--<nav class="navbar navbar-default">-->
	...
	<div style="width:100%;">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown open " style="margin-inline:0px ;margin-top:16px ;">
...
<li class="dropdown open " style="margin-left:10px ;margin-top:16px;margin-right:16px;">
...
<ul class="list dropdown-menu1" role="menu1">
