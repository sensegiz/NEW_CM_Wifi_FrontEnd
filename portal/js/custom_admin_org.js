...
var apiEraseGatewayData = 'erase-gateway-data';
	...
	function getAdminGateways() {
            $('#loader').show();
                    ...
                    $.ajax({
                            url: basePathAdmin + apiUrlAdminGateways,                           
                            type: 'GET',						
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'json',
                            async: false,                           
                                ...
                                if(data.status == 'success') {
                                    if(data.records.length > 0){
                                        ...
                                        $.each(records, function (index, value) {
                                            ...
                                            console.log('gateway_status',gateway_status);
						...
						restore_btn = '<button type="button" class="btn btn-secondary restore-gateway" data-gateway="'+gateway_id+'">Restore</button>';
                                            ...
                                            sc_html  +=  '<tr>'  
                                                        +'<td>'+(index+1)+'</td>'                                                              
                                                        +'<td>'+gateway_type_html+' &nbsp;<a href="devices-admin.php?id='+gateway_id+'">'+gateway_id+'</a></td>'                                       
                                                        +'<td>'+user_email+'</td>'    
                                                        +'<td>'+date+'</td>'
