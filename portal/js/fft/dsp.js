...
function FourierTransform(bufferSize, sampleRate) {
  ...
  this.spectrum   = new Float64Array(bufferSize/2); //this.spectrum   = new Float64Array(bufferSize/2);
  ...
  this.calculateSpectrum = function() {
    ...
    for (var i = 0, N = bufferSize; i < N; i++) {
      rval = real[i];
      ival = imag[i];
...
DFT.prototype.forward = function(buffer) {
  ...
  for (var k = 0; k < this.bufferSize; k++) {  //this.bufferSize/2
    rval = 0.0;
    ival = 0.0;
